...
UBUNTU_18=ubuntu:18.04 # Keep for version 7.x
...
UBUNTU_18_X86_LAST_LAYER_ID=$(docker inspect "${UBUNTU_18}" | jq ".[0].RootFS.Layers[-1]"); export UBUNTU_18_X86_LAST_LAYER_ID
...
UBUNTU_18_ARM_LAST_LAYER_ID=$(docker inspect "${UBUNTU_18}" | jq ".[0].RootFS.Layers[-1]"); export UBUNTU_18_ARM_LAST_LAYER_ID
